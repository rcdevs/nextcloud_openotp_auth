OC.L10N.register(
	...
	"Give an Identifiant to the owncloud Application (Default Owncloud) - Allows OpenOTP server to apply specifics policies for requests from owncloud app / Displays when receiving OTP via email / Displays in OpenOTP Logs" : "Give an Identifiant to the owncloud Application (Default Owncloud) - Allows OpenOTP server to apply specifics policies for requests from owncloud app / Displays when receiving OTP via email / Displays in OpenOTP Logs",
	...
	"User login with Owncloud password - OpenOTP" : "User login with Owncloud password - OpenOTP",
